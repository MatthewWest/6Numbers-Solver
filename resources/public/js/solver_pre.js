...
domina.array_like_QMARK_ = function(a) {
  if(cljs.core.truth_(a)) {
    var b = cljs.core.not.call(null, a.name);
    return b ? a.length : b
  }
  return a
};
  ...
  return cljs.core.doall.call(null, function i(a) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        ...
        return b ? (b = cljs.core.first.call(null, b), cljs.core.cons.call(null, cljs.core.truth_(e) ? goog.events.listenOnce(b, g, f, d) : goog.events.listen(b, g, f, d), i.call(null, cljs.core.rest.call(null, a)))) : null
      }
    }, null)
...
six_numbers_solver.calc.divide_by_each = function(a, b) {
  return cljs.core.map.call(null, function(b) {
    return cljs.core.truth_(six_numbers_solver.calc.is_valid_QMARK_.call(null, a, b)) ? b : null
  }, cljs.core.map.call(null, function(b) {
    return a / b
  }, b))
};
six_numbers_solver.calc.add_to_each = function(a, b) {
  return cljs.core.map.call(null, function(b) {
    return cljs.core.truth_(six_numbers_solver.calc.is_valid_QMARK_.call(null, a, b)) ? b : null
  }, cljs.core.map.call(null, function(b) {
    return a + b
...
six_numbers_solver.calc.subtract_by_each = function(a, b) {
  return cljs.core.map.call(null, function(b) {
    return cljs.core.truth_(six_numbers_solver.calc.is_valid_QMARK_.call(null, a, b)) ? b : null
  }, cljs.core.map.call(null, function(b) {
    return a - b
...
six_numbers_solver.calc.multiply_by_each = function(a, b) {
  return cljs.core.map.call(null, function(b) {
    return cljs.core.truth_(six_numbers_solver.calc.is_valid_QMARK_.call(null, a, b)) ? b : null
  }, cljs.core.map.call(null, function(b) {
    return a * b
...
six_numbers_solver.calc.solved_by_QMARK_ = function(a, b, c) {
  return cljs.core.some.call(null, function(a) {
    ...
    return function f(a) {
      return new cljs.core.LazySeq(null, !1, function() {
        for(var b = a;;) {
          var i = cljs.core.seq.call(null, b);
          if(i) {
            var j = i, l = cljs.core.first.call(null, j), i = function(a, b) {
              return function p(a) {
                return new cljs.core.LazySeq(null, !1, function() {
                  for(var f = a;;) {
                    var g = cljs.core.seq.call(null, f);
                    if(g) {
                      if(g = cljs.core.first.call(null, g), cljs.core._EQ_.call(null, b, g)) {
                        f = cljs.core.rest.call(null, f)
                      }else {
                        return cljs.core.cons.call(null, cljs.core._EQ_.call(null, cljs.core.nth.call(null, c, b), cljs.core.nth.call(null, d, g)) ? cljs.core.PersistentVector.fromArray([cljs.core.nth.call(null, c, b), cljs.core.nth.call(null, c, g)], !0) : null, p.call(null, cljs.core.rest.call(null, f)))
                      }
                    }else {
                      return null
                    }
            ...
            if(i = cljs.core.seq.call(null, i.call(null, cljs.core.range.call(null, cljs.core.count.call(null, c))))) {
              return cljs.core.concat.call(null, i, f.call(null, cljs.core.rest.call(null, b)))
            }
    ...
    }.call(null, cljs.core.range.call(null, cljs.core.count.call(null, c)))
  }())
};
six_numbers_solver.calc.remove_index = function(a, b) {
  return cljs.core.concat.call(null, cljs.core.take.call(null, a, b), cljs.core.drop.call(null, 1 + a, b))
};
six_numbers_solver.calc.list_for_recursion = function(a, b, c, d) {
  return cljs.core.filter.call(null, function(b) {
    return six_numbers_solver.calc.is_valid_QMARK_.call(null, a, cljs.core.second.call(null, b))
  }, function() {
    var e = c.call(null, a, b);
    return function g(c) {
      return new cljs.core.LazySeq(null, !1, function() {
        for(;;) {
          var i = cljs.core.seq.call(null, c);
          return i ? (i = cljs.core.first.call(null, i), cljs.core.cons.call(null, cljs.core.PersistentVector.fromArray([[cljs.core.str(cljs.core.nth.call(null, e, i)), cljs.core.str(d), cljs.core.str(cljs.core.nth.call(null, b, i)), cljs.core.str(" = "), cljs.core.str(a)].join(""), cljs.core.nth.call(null, e, i), six_numbers_solver.calc.remove_index.call(null, i, b)], !0), g.call(null, cljs.core.rest.call(null, c)))) : null
        }
      }, null)
...
six_numbers_solver.calc.solve = function(a, b) {
  return six_numbers_solver.calc.solve_n_deep.call(null, a, b, cljs.core.count.call(null, b) - 1)
};
cljs.reader = {};
...
six_numbers_solver.web = {};
six_numbers_solver.web.print_solution = function(a) {
  ...
  return cljs.core.doall.call(null, cljs.core.map.call(null, function(a) {
    return domina.append_BANG_.call(null, domina.by_id.call(null, "numberEntry"), "" + cljs.core.str(cljs.core.map_QMARK_.call(null, a) ? [cljs.core.str("<div"), cljs.core.str(hiccups.runtime.render_attr_map.call(null, cljs.core.merge.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'class"], {"\ufdd0'id":null, "\ufdd0'class":"solution"}), a))), cljs.core.str(">"), cljs.core.str("</div>")].join("") : [cljs.core.str('<div class="solution">'), cljs.core.str(hiccups.runtime.render_html.call(null, 
    a)), cljs.core.str("</div>")].join("")))
  }, clojure.string.split_lines.call(null, a)))
};
six_numbers_solver.web.web_solve = function() {
  var a = domina.value.call(null, domina.by_id.call(null, "target")), b = domina.value.call(null, domina.by_id.call(null, "num1")), c = domina.value.call(null, domina.by_id.call(null, "num2")), d = domina.value.call(null, domina.by_id.call(null, "num3")), e = domina.value.call(null, domina.by_id.call(null, "num4")), f = domina.value.call(null, domina.by_id.call(null, "num5")), g = domina.value.call(null, domina.by_id.call(null, "num6")), b = cljs.core.map.call(null, cljs.reader.read_string, cljs.core.filter.call(null, 
  function(a) {
    return cljs.core.not.call(null, clojure.string.blank_QMARK_.call(null, a))
  }, cljs.core.PersistentVector.fromArray([b, c, d, e, f, g], !0)));
  return six_numbers_solver.web.print_solution.call(null, six_numbers_solver.calc.solve.call(null, a, b))
};
six_numbers_solver.web.init = function() {
  return cljs.core.truth_(function() {
    var a = document;
    return cljs.core.truth_(a) ? document.getElementById : a
  }()) ? domina.events.listen_BANG_.call(null, domina.by_id.call(null, "calc"), "\ufdd0'click", six_numbers_solver.web.web_solve) : null
};
